...
-- Heuristic considers the current position and the adjacent positions, choosing adjacent to the lower weight.
...
main = do
  ...
  --boot [overworldMap, dungeon1Map, dungeon2Map, dungeon3Map] TODO: put object in map. make Link tracer
